...
public final class MovieList {
    ...
    public static List<Movie> setupMovies() {
        ...
        String videoUrl[] = {
                Uri.parse("android.resource://com.aviators.eva/raw/"+R.raw.timelapse).toString(),
        ...
        String bgImageUrl[] = {
                "https://www.visitdubai.com/-/media/summercampaign/summer-2017/itineraries/one-day-in-dubai.jpg",
